...
classifiers
  = HashMap.fromList
      [("Military Spouse Day",
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.47922857935416424,
                               unseen = -7.274479558773871,
                               likelihoods =
                                 HashMap.fromList
                                   [("Navaratriyear (latent)", -6.580639137284949),
                                    ("Father's Dayyear (latent)", -6.580639137284949),
                                    ("Karva Chauthyear (latent)", -6.580639137284949),
                                    ("<day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.580639137284949),
                                    ("Maha Shivaratriyear (latent)", -6.580639137284949),
                                    ("Ramadanyear (latent)", -5.327876168789581),
                                    ("<datetime> - <datetime> (interval)on <day>",
                                     -5.1943447761650585),
                                    ("Military Spouse Dayyear (latent)", -6.580639137284949),
                                    ("Bhai Doojyear (latent)", -6.580639137284949),
                                    ("hourday", -4.565736116742684),
                                    ("dayhour", -3.536116699561526),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.1943447761650585),
                                    ("Martin Luther King's Dayyear (latent)", -6.175174029176785),
                                    ("Shemini Atzeretyear (latent)", -6.580639137284949),
                                    ("daymonth", -4.565736116742684),
                                    ("monthday", -6.175174029176785),
                                    ("monthyear", -4.788879668056894),
                                    ("Yom Ha'atzmautyear (latent)", -6.580639137284949),
                                    ("Orthodox Good Fridayyear (latent)", -6.175174029176785),
                                    ("Vijayadashamiyear (latent)", -6.580639137284949),
                                    ("Administrative Professionals' Dayyear (latent)",
                                     -5.1943447761650585),
                                    ("Thanksgiving Dayyear (latent)", -5.482026848616839),
                                    ("Thai Pongalyear (latent)", -5.887491956725004),
                                    ("Thiru Onamyear (latent)", -5.887491956725004),
                                    ("hhhmmabsorption of , after named day", -6.580639137284949),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -6.580639137284949),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.664348405410794),
                                    ("<day-of-month> (ordinal)Wednesday", -6.580639137284949),
                                    ("Krishna Janmashtamiyear (latent)", -6.175174029176785),
                                    ("Guru Gobind Singh Jayantiyear (latent)", -6.580639137284949),
                                    ("houryear", -5.664348405410794),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -6.580639137284949),
                                    ("Christmas<time-of-day> am|pm", -6.580639137284949),
                                    ("last <day-of-week> of <time>year (latent)",
                                     -6.580639137284949),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.887491956725004),
                                    ("intersectin|during <named-month>|year", -6.580639137284949),
                                    ("<time-of-day> am|pmintersect", -5.327876168789581),
                                    ("Earth Houryear (latent)", -6.580639137284949),
                                    ("Ganesh Chaturthiyear (latent)", -6.580639137284949),
                                    ("Octoberyear (latent)", -5.076561740508675),
                                    ("intersect<time-of-day> am|pm", -6.580639137284949),
                                    ("Mattu Pongalyear (latent)", -6.580639137284949),
                                    ("Saturday<part-of-day> at <time-of-day>", -6.580639137284949),
                                    ("Daylight Saving Start Dayyear (latent)", -5.664348405410794),
                                    ("Shavuotyear (latent)", -6.580639137284949),
                                    ("Parsi New Yearyear (latent)", -5.664348405410794),
                                    ("at <time-of-day>in|within|after <duration>",
                                     -6.580639137284949),
                                    ("the <day-of-month> (ordinal)intersect by \",\", \"of\", \"from\" for year",
                                     -6.580639137284949),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -6.580639137284949),
                                    ("todayin|within|after <duration>", -6.580639137284949),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -6.175174029176785),
                                    ("Marchyear (latent)", -6.580639137284949),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hhhmm",
                                     -6.175174029176785),
                                    ("Sukkotyear (latent)", -6.175174029176785),
                                    ("hhhmmintersect", -6.175174029176785),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -6.175174029176785),
                                    ("Daylight Saving End Dayyear (latent)", -5.664348405410794),
                                    ("Clean Mondayyear (latent)", -6.175174029176785),
                                    ("the <day-of-month> (ordinal)Sunday", -6.580639137284949),
                                    ("monthhour", -6.175174029176785),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.664348405410794),
                                    ("todayat <time-of-day>", -6.580639137284949),
                                    ("Thursday<time> timezone", -4.182743864486579),
                                    ("tonight<time-of-day> am|pm", -6.580639137284949),
                                    ("time-of-day (latent)tonight", -6.175174029176785),
                                    ("from|since|after <time>December", -6.580639137284949),
                                    ("Emergency Medical Services for Children Dayyear (latent)",
                                     -6.580639137284949),
                                    ("<time-of-day> am|pmon <day>", -4.565736116742684),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -6.580639137284949),
                                    ("yyyy-mm-ddhh:mm:ss", -6.175174029176785),
                                    ("Tax Daythis|last|next <cycle>", -6.580639137284949),
                                    ("dayday", -3.747425793228733),
                                    ("<time> <part-of-day>at <time-of-day>", -6.175174029176785),
                                    ("mm/ddat <time-of-day>", -6.580639137284949),
                                    ("tonightat <time-of-day>", -5.482026848616839),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.887491956725004),
                                    ("Dayananda Saraswati Jayantiyear (latent)",
                                     -6.580639137284949),
                                    ("today<time-of-day> am|pm", -6.580639137284949),
                                    ("Februarythe <day-of-month> (ordinal)", -6.175174029176785),
                                    ("at <time-of-day><time> <part-of-day>", -6.580639137284949),
                                    ("<day-of-month> (ordinal)intersect", -6.175174029176785),
                                    ("mm/dd<time-of-day> am|pm", -6.580639137284949),
                                    ("hourhour", -3.610224671715248),
                                    ("Mahavir Jayantiyear (latent)", -6.175174029176785),
                                    ("Navaratriin|during <named-month>|year", -6.580639137284949),
                                    ("Wednesdaythis|last|next <cycle>", -6.580639137284949),
                                    ("Lentyear (latent)", -6.580639137284949),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.7088369603833575),
                                    ("Boghiyear (latent)", -6.580639137284949),
                                    ("dayyear", -1.8015156441734197),
                                    ("Karva Chauthin|during <named-month>|year",
                                     -6.580639137284949),
                                    ("Thursdayfrom|since|after <time>", -6.175174029176785),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -6.580639137284949),
                                    ("Thursdayat <time-of-day>", -5.887491956725004),
                                    ("Islamic New Yearyear (latent)", -6.175174029176785),
                                    ("Laylat al-Qadryear (latent)", -5.664348405410794),
                                    ("part of days<time-of-day> am|pm", -6.580639137284949),
                                    ("Shrove Tuesdayyear (latent)", -6.580639137284949),
                                    ("intersect by \",\", \"of\", \"from\" for year<time-of-day> am|pm",
                                     -5.887491956725004),
                                    ("hourminute", -6.175174029176785),
                                    ("<time-of-day> am|pmtomorrow", -5.664348405410794),
                                    ("Yom Kippuryear (latent)", -6.580639137284949),
                                    ("<day-of-month> (ordinal)Tuesday", -5.887491956725004),
                                    ("<part-of-day> of <time>year (latent)", -6.580639137284949),
                                    ("minutehour", -5.327876168789581),
                                    ("Kaanum Pongalyear (latent)", -6.175174029176785),
                                    ("Maha Saptamiyear (latent)", -6.580639137284949),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.887491956725004),
                                    ("time-of-day (latent)tomorrow", -5.664348405410794),
                                    ("part of daysat <time-of-day>", -4.971201224850849),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -4.565736116742684),
                                    ("for <duration> from <time>December", -6.580639137284949),
                                    ("tomorrow<time-of-day> sharp|exactly", -6.580639137284949),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -5.327876168789581),
                                    ("intersect by \",\", \"of\", \"from\" for yearhhhmm",
                                     -5.327876168789581),
                                    ("time-of-day (latent)this <part-of-day>", -6.580639137284949),
                                    ("Pentecostyear (latent)", -6.580639137284949),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.327876168789581),
                                    ("<day-of-month> (ordinal)February", -6.580639137284949),
                                    ("Eid al-Fitryear (latent)", -5.1943447761650585),
                                    ("Vasant Panchamiin|during <named-month>|year",
                                     -6.580639137284949),
                                    ("Mini-Tuesday<duration> hence|ago", -6.580639137284949),
                                    ("Mondayin|during the <part-of-day>", -6.580639137284949),
                                    ("Chhathin|during <named-month>|year", -6.580639137284949),
                                    ("Diwaliin|during <named-month>|year", -6.580639137284949),
                                    ("this <part-of-day><time-of-day> am|pm", -6.580639137284949),
                                    ("Vaisakhiin|during <named-month>|year", -6.580639137284949),
                                    ("Guru Ravidass Jayantiyear (latent)", -5.327876168789581),
                                    ("Raksha Bandhanyear (latent)", -6.580639137284949),
                                    ("daysecond", -6.175174029176785),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -6.175174029176785),
                                    ("Emancipation Dayyear (latent)", -5.887491956725004),
                                    ("Ratha-Yatrayear (latent)", -6.580639137284949),
                                    ("Ashurayear (latent)", -6.580639137284949),
                                    ("Tuesdayin|during <named-month>|year", -6.580639137284949),
                                    ("Chinese New Yearyear (latent)", -6.580639137284949),
                                    ("tomorrowintersect", -6.580639137284949),
                                    ("Lag BaOmeryear (latent)", -6.580639137284949),
                                    ("last weekend of <named-month>year (latent)",
                                     -6.580639137284949),
                                    ("Eid al-Adhayear (latent)", -4.4405729737886785),
                                    ("intersectin|during the <part-of-day>", -6.580639137284949),
                                    ("Palm Sundayyear (latent)", -6.580639137284949),
                                    ("Christmasat <time-of-day>", -6.580639137284949),
                                    ("Passoveryear (latent)", -6.580639137284949),
                                    ("Lazarus Saturdayyear (latent)", -6.580639137284949),
                                    ("<day-of-month> (ordinal or number) <named-month>year (latent)",
                                     -6.580639137284949),
                                    ("Cyber Mondayyear (latent)", -6.175174029176785),
                                    ("hhhmmon <day>", -5.664348405410794),
                                    ("Yom HaShoahyear (latent)", -6.175174029176785),
                                    ("Thursday<datetime> - <datetime> (interval)",
                                     -6.175174029176785),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -6.580639137284949),
                                    ("Septemberyear (latent)", -6.175174029176785),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -5.076561740508675),
                                    ("Halloweenyear (latent)", -6.580639137284949),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"<time-of-day> am|pm",
                                     -6.580639137284949),
                                    ("at <time-of-day>intersect", -5.664348405410794),
                                    ("Rosh Hashanahyear (latent)", -5.887491956725004),
                                    ("Super Tuesdayyear (latent)", -5.664348405410794),
                                    ("Dhanterasyear (latent)", -6.580639137284949),
                                    ("Tu BiShvatyear (latent)", -6.580639137284949),
                                    ("<day-of-month> (ordinal)December", -5.887491956725004),
                                    ("Holiyear (latent)", -5.887491956725004),
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -6.580639137284949),
                                    ("Holika Dahanyear (latent)", -5.887491956725004),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.175174029176785),
                                    ("dayminute", -3.230735050010344),
                                    ("Mawlidyear (latent)", -6.580639137284949),
                                    ("from <datetime> - <datetime> (interval)on <day>",
                                     -6.175174029176785),
                                    ("<datetime> - <datetime> (interval)tomorrow",
                                     -6.580639137284949),
                                    ("Jumu'atul-Widayear (latent)", -5.664348405410794),
                                    ("minuteday", -2.831135061354578),
                                    ("absorption of , after named dayintersect",
                                     -5.887491956725004),
                                    ("intersectyear (latent)", -6.580639137284949),
                                    ("Orthodox Easter Sundayyear (latent)", -6.580639137284949),
                                    ("time-of-day (latent)in|within|after <duration>",
                                     -6.580639137284949),
                                    ("<ordinal> <cycle> of <time>year (latent)",
                                     -6.580639137284949),
                                    ("Mini-Tuesdayyear (latent)", -6.580639137284949),
                                    ("intersecthhhmm", -6.175174029176785),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -6.580639137284949),
                                    ("Boss's Dayyear (latent)", -6.175174029176785),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.580639137284949),
                                    ("Global Youth Service Dayyear (latent)", -6.580639137284949),
                                    ("Dhanterasin|during <named-month>|year", -6.580639137284949),
                                    ("Super Tuesdayin|during <named-month>|year",
                                     -6.580639137284949),
                                    ("tonight<time-of-day> o'clock", -6.580639137284949),
                                    ("Tisha B'Avyear (latent)", -6.580639137284949),
                                    ("Isra and Mi'rajyear (latent)", -5.664348405410794),
                                    ("at <time-of-day>on <day>", -4.971201224850849),
                                    ("at <time-of-day>absorption of , after named day",
                                     -6.175174029176785),
                                    ("time-of-day (latent)<time> <part-of-day>",
                                     -5.887491956725004),
                                    ("Christmasyear (latent)", -6.175174029176785),
                                    ("Saturdayintersect", -6.580639137284949),
                                    ("Naraka Chaturdashiyear (latent)", -6.175174029176785),
                                    ("Thai Pongalin|during <named-month>|year", -6.580639137284949),
                                    ("Emergency Medical Services Weekyear (latent)",
                                     -6.580639137284949),
                                    ("dayweek", -6.580639137284949),
                                    ("Easter Sundayyear (latent)", -5.887491956725004),
                                    ("between <time-of-day> and <time-of-day> (interval)on <day>",
                                     -6.175174029176785),
                                    ("weekyear", -5.482026848616839),
                                    ("Super Tuesdaythis|last|next <cycle>", -6.580639137284949),
                                    ("King's Dayyear (latent)", -5.076561740508675),
                                    ("hh:mmin|during the <part-of-day>", -5.664348405410794),
                                    ...
                                    ("Rama Navamiyear (latent)", -6.580639137284949),
                                    ("February<time> <part-of-day>", -6.580639137284949),
                                    ("National Grandparents Dayyear (latent)", -6.580639137284949),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.887491956725004),
                                    ("Great Lentyear (latent)", -6.580639137284949),
                                    ("tomorrowat <time-of-day>", -5.887491956725004),
                                    ("hhmm (latent)in|during the <part-of-day>",
                                     -6.580639137284949),
                                    ("Labor Dayyear (latent)", -6.580639137284949),
                                    ("tomorrow<part-of-day> at <time-of-day>", -6.175174029176785),
                                    ("Ugadiyear (latent)", -5.1943447761650585),
                                    ("Vaisakhiyear (latent)", -5.887491956725004),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\" for year",
                                     -5.887491956725004),
                                    ("last <cycle> of <time>year (latent)", -5.887491956725004),
                                    ("at <time-of-day>tomorrow", -6.175174029176785),
                                    ("tomorrow<time-of-day> am|pm", -6.580639137284949),
                                    ("President's Dayyear (latent)", -6.580639137284949),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -6.580639137284949),
                                    ("Diwaliyear (latent)", -6.580639137284949),
                                    ("between <time> and <time>on <day>", -6.175174029176785),
                                    ("Black Fridayyear (latent)", -6.175174029176785),
                                    ("the <ordinal> last <cycle> of <time>year (latent)",
                                     -6.580639137284949),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -6.580639137284949),
                                    ("Chhathyear (latent)", -6.175174029176785),
                                    ("Vasant Panchamiyear (latent)", -6.580639137284949),
                                    ("Tax Dayyear (latent)", -5.482026848616839),
                                    ("Rabindra Jayantiyear (latent)", -5.327876168789581),
                                    ("this <part-of-day>at <time-of-day>", -5.327876168789581),
                                    ("St Patrick's Dayyear (latent)", -6.580639137284949),
                                    ("Thursday<time> (timezone)", -6.580639137284949),
                                    ("<day-of-month> (ordinal or number) of <month>in|during the <part-of-day>",
                                     -6.580639137284949),
                                    ("Pargat Diwasyear (latent)", -5.327876168789581),
                                    ("<datetime> - <datetime> (interval)July", -6.175174029176785),
                                    ("on <day><named-month> <day-of-month> (non ordinal)",
                                     -5.887491956725004),
                                    ("Februaryintersect", -6.580639137284949),
                                    ("Mother's Dayyear (latent)", -6.580639137284949),
                                    ("Simchat Torahyear (latent)", -6.580639137284949),
                                    ("minuteyear", -6.580639137284949)],
                               n = 553},
                   koData =
                     ClassData{prior = -0.9656409632662919, unseen = -6.92461239604856,
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursdayhhhmm", -4.726404050802208),
                                    ("hourday", -3.6277917621340983),
                                    ("<hour-of-day> <integer><time-of-day> am|pm",
                                     -6.230481447578482),
                                    ("<day-of-month> (ordinal)August", -6.230481447578482),
                                    ("dayhour", -3.5563327981519532),
                                    ("<time> timezoneyear (latent)", -5.537334267018537),
                                    ("<time-of-day> - <time-of-day> (interval)on <day>",
                                     -5.314190715704327),
                                    ("Tuesdayfrom|since|after <time>", -5.131869158910372),
                                    ("daymonth", -3.522431246476272),
                                    ("hourquarter", -5.314190715704327),
                                    ("monthyear", -4.977718479083114),
                                    ("<time-of-day> am|pmyear (latent)", -5.537334267018537),
                                    ("Thai Pongalyear (latent)", -5.537334267018537),
                                    ("intersecthh:mm", -6.230481447578482),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.825016339470317),
                                    ("<day-of-month> (ordinal)Wednesday", -6.230481447578482),
                                    ("houryear", -4.438721978350427),
                                    ("from <time-of-day> - <time-of-day> (interval)July",
                                     -6.230481447578482),
                                    ("<day-of-month> (ordinal)October", -6.230481447578482),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.537334267018537),
                                    ("hournograin", -4.977718479083114),
                                    ("<time-of-day> am|pmintersect", -4.977718479083114),
                                    ("Octoberyear (latent)", -6.230481447578482),
                                    ("Good Fridayyear (latent)", -5.825016339470317),
                                    ("time-of-day (latent)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.825016339470317),
                                    ("early morningat <time-of-day>", -6.230481447578482),
                                    ("until <time>on <day>", -5.537334267018537),
                                    ("part of days<time-of-day> - <time-of-day> (interval)",
                                     -6.230481447578482),
                                    ("time-of-day (latent)intersect", -5.537334267018537),
                                    ("todayin <number> (implicit minutes)", -6.230481447578482),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year (latent)",
                                     -5.537334267018537),
                                    ...
                                    ("about|exactly <time-of-day>year (latent)",
                                     -6.230481447578482),
                                    ("hh:mmon <day>", -4.977718479083114),
                                    ("hhhmmintersect", -5.825016339470317),
                                    ("absorption of , after named dayJuly", -5.314190715704327),
                                    ("from|since|after <time>July", -5.825016339470317),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year (latent)",
                                     -5.314190715704327),
                                    ("Clean Mondayyear (latent)", -6.230481447578482),
                                    ("monthhour", -6.230481447578482),
                                    ("<day-of-month> (ordinal)intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.825016339470317),
                                    ("hourmonth", -4.090415284082211),
                                    ("todayat <time-of-day>", -6.230481447578482),
                                    ("hhhmmyear (latent)", -4.977718479083114),
                                    ("from|since|after <time>December", -6.230481447578482),
                                    ("from|since|after <time><time-of-day> am|pm",
                                     -6.230481447578482),
                                    ("<time-of-day> am|pmon <day>", -4.977718479083114),
                                    ("Mondayyear (latent)", -5.131869158910372),
                                    ("dayday", -3.9791896489719867),
                                    ("mm/ddat <time-of-day>", -5.825016339470317),
                                    ("on <day>September", -5.537334267018537),
                                    ("time-of-day (latent)September", -5.825016339470317),
                                    ("hourhour", -4.151039905898646),
                                    ("time-of-day (latent)on <day>", -4.726404050802208),
                                    ("<datetime> - <datetime> (interval)year (latent)",
                                     -6.230481447578482),
                                    ("time-of-day (latent)<cycle> after|before <time>",
                                     -5.825016339470317),
                                    ("dayyear", -2.898276937403278),
                                    ("Thursdaymm/dd", -6.230481447578482),
                                    ("New Year's Dayyear (latent)", -5.314190715704327),
                                    ("Tuesdayyear (latent)", -5.131869158910372),
                                    ("time-of-day (latent)Sunday", -5.825016339470317),
                                    ("Thursdayfrom|since|after <time>", -4.525733355340057),
                                    ("Thursdayat <time-of-day>", -4.6210435351443815),
                                    ("<integer> to|till|before <hour-of-day>September",
                                     -6.230481447578482),
                                    ("Aprilyear (latent)", -6.230481447578482),
                                    ("the <day-of-month> (ordinal)July", -6.230481447578482),
                                    ("the <day-of-month> (number)July", -6.230481447578482),
                                    ("monthminute", -6.230481447578482),
                                    ("<time-of-day> am|pmtomorrow", -5.825016339470317),
                                    ("Thursdayhh:mm", -5.314190715704327),
                                    ("<day-of-month> (ordinal)Tuesday", -5.825016339470317),
                                    ("minutemonth", -4.090415284082211),
                                    ("time-of-day (latent)Friday", -5.825016339470317),
                                    ("minutehour", -6.230481447578482),
                                    ("Tuesdayin <number> (implicit minutes)", -6.230481447578482),
                                    ("part of daysat <time-of-day>", -5.131869158910372),
                                    ("time-of-day (latent)this|last|next <cycle>",
                                     -3.879106190415004),
                                    ("<day-of-month> (ordinal)Sunday", -6.230481447578482),
                                    ("Augustyear (latent)", -5.825016339470317),
                                    ("week-endin|during <named-month>|year", -6.230481447578482),
                                    ("time-of-day (latent)Tuesday", -5.825016339470317),
                                    ...
                                    ("Sundayyear (latent)", -5.314190715704327),
                                    ("hourweek", -5.314190715704327),
                                    ("the <day-of-month> (ordinal)Monday", -5.537334267018537),
                                    ("Christmasat <time-of-day>", -6.230481447578482),
                                    ("from|since|after <time>year (latent)", -5.131869158910372),
                                    ("hhhmmon <day>", -5.314190715704327),
                                    ("yesterday<time-of-day> am|pm", -6.230481447578482),
                                    ("<day-of-month> (ordinal)July", -5.537334267018537),
                                    ("Tuesday<duration> hence|ago", -6.230481447578482),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -6.230481447578482),
                                    ("mm/ddyear (latent)", -6.230481447578482),
                                    ("Thursday<time-of-day> - <time-of-day> (interval)",
                                     -6.230481447578482),
                                    ("in|during <named-month>|yearyear (latent)",
                                     -6.230481447578482),
                                    ("Tuesdaythis|last|next <cycle>", -6.230481447578482),
                                    ("at <time-of-day>intersect", -5.314190715704327),
                                    ("hh:mmyear (latent)", -4.844187086458591),
                                    ("Holiyear (latent)", -6.230481447578482),
                                    ("until <time><time-of-day> am|pm", -6.230481447578482),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.825016339470317),
                                    ("dayminute", -3.340109689682317),
                                    ("yyyy-mm-ddhh:mm", -5.825016339470317),
                                    ("intersectfrom|since|after <time>", -5.825016339470317),
                                    ("intersectSeptember", -4.35867927067689),
                                    ("minuteday", -3.0734810264283685),
                                    ("absorption of , after named dayintersect",
                                     -6.230481447578482),
                                    ("intersectyear (latent)", -6.230481447578482),
                                    ("Februaryin|during the <part-of-day>", -6.230481447578482),
                                    ("<duration> after|before|from|past <time>December",
                                     -6.230481447578482),
                                    ("time-of-day (latent)July", -5.537334267018537),
                                    ("Saturdayyear (latent)", -6.230481447578482),
                                    ("hhhmmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -6.230481447578482),
                                    ("<day-of-month> (ordinal)Monday", -4.977718479083114),
                                    ("at <time-of-day>on <day>", -5.314190715704327),
                                    ("absorption of , after named daySeptember",
                                     -4.977718479083114),
                                    ("Naraka Chaturdashiyear (latent)", -6.230481447578482),
                                    ("from|since|after <time>on <day>", -5.314190715704327),
                                    ("dayweek", -6.230481447578482),
                                    ("Easter Sundayyear (latent)", -5.825016339470317),
                                    ("Thursday<time-of-day> am|pm", -4.977718479083114),
                                    ("weekyear", -5.825016339470317),
                                    ("time-of-day (latent)Thursday", -5.825016339470317),
                                    ("<named-month> <day-of-month> (non ordinal)until <time>",
                                     -6.230481447578482),
                                    ("<day-of-month> (ordinal)April", -6.230481447578482),
                                    ("yyyy-mm-dd<time-of-day> - <time-of-day> (interval)",
                                     -5.825016339470317),
                                    ("intersect by \",\", \"of\", \"from\" for yearhh:mm",
                                     -5.537334267018537),
                                    ("Sundayfrom|since|after <time>", -6.230481447578482),
                                    ("absorption of , after named dayFebruary", -5.314190715704327),
                                    ("time-of-day (latent)in|during the <part-of-day>",
                                     -5.825016339470317),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -6.230481447578482),
                                    ("tomorrowat <time-of-day>", -6.230481447578482),
                                    ("daynograin", -5.825016339470317),
                                    ("Fridayin|during <named-month>|year", -6.230481447578482),
                                    ("<integer> to|till|before <hour-of-day>July",
                                     -5.825016339470317),
                                    ("last <cycle> of <time>year (latent)", -5.825016339470317),
                                    ("tomorrow<time-of-day> am|pm", -6.230481447578482),
                                    ("<named-month> <day-of-month> (non ordinal)year (latent)",
                                     -5.537334267018537),
                                    ("Diwaliyear (latent)", -5.825016339470317),
                                    ("<time-of-day> - <time-of-day> (interval)July",
                                     -6.230481447578482),
                                    ("this <part-of-day>at <time-of-day>", -5.314190715704327),
                                    ("Fridayyear (latent)", -5.314190715704327),
                                    ("Tuesdayin|within|after <duration>", -6.230481447578482),
                                    ("time-of-day (latent)April", -6.230481447578482),
                                    ("minuteyear", -4.033256870242263)],
                               n = 340}}),
       ("one eleven",
        Classifier{okData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..twentieth,thirtieth,...)",
                                     -1.4816045409242156),
                                    ("ordinal (digits)", -0.2578291093020998)],
                               n = 20},
                   koData =
                     ClassData{prior = -0.6690496289808848,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("ordinals (first..twentieth,thirtieth,...)",
                                     -0.570544858467613),
                                    ("ordinal (digits)", -0.832909122935104)],
                               n = 21}}),
       ...
       ("on <day>",
        Classifier{okData =
                     ClassData{prior = -0.25593337413720063,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("Thursday", -1.845826690498331), ("mm/dd", -3.349904087274605),
                                    ("absorption of , after named day", -2.6567569067146595),
                                    ("intersect", -2.6567569067146595),
                                    ("Saturday", -2.6567569067146595),
                                    ("Friday", -2.9444389791664407), ("day", -0.8241754429663495),
                                    ("the <day-of-month> (ordinal)", -3.349904087274605),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -2.6567569067146595)],
                               n = 24},
                   koData =
                     ClassData{prior = -1.488077055429833, unseen = -3.1780538303479458,
                               likelihoods =
                                 HashMap.fromList
                                   [("intersect", -1.749199854809259), ("day", -1.0560526742493137),
                                    ("the <day-of-month> (ordinal)", -2.4423470353692043),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -1.749199854809259)],
                               n = 7}}),
       ("Thiru Onam",
