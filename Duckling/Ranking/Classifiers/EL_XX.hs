      ...
      [("midnight",
       ...
       ("ordinals (1st..12th, 20th, 30th..90th)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.4700036292457356, unseen = -3.951243718581427,
       ...
       ("absorption of article before time",
        Classifier{okData =
                     ClassData{prior = -0.23889190828234896, unseen = -6.54534966033442,
                               likelihoods =
                                 HashMap.fromList
                                   [("midnight", -5.850764665004847),
                                    ("last <cycle> <time>'s'", -3.9048545159495336),
                                    ("week", -3.6535400876686275),
                                    ("Father's Day", -5.445299556896683),
                                    ("thursday", -5.445299556896683), ("fall", -5.445299556896683),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.464470303884956),
                                    ("<time> <part-of-day>", -4.241326752570746),
                                    ("absorption of , after named day", -5.445299556896683),
                                    ("revolution day", -4.7521523763367375),
                                    ("October", -4.146016572766421),
                                    ("wednesday", -5.850764665004847), ("July", -5.445299556896683),
                                    ("<ordinal> quarter", -5.850764665004847),
                                    ("saturday", -5.157617484444901),
                                    ("Last year", -5.157617484444901),
                                    ("intersect", -2.8062422272814236),
                                    ("half after|past <integer> (hour-of-day)", -5.850764665004847),
                                    ("<ordinal> <cycle> of <time>", -5.850764665004847),
                                    ("next <cycle>", -4.464470303884956),
                                    ("the <cycle> of <time>", -4.5980016965094785),
                                    ("<ordinal> quarter <year>", -5.850764665004847),
                                    ("second", -4.9344739331306915), ("monday", -5.445299556896683),
                                    ("valentine's day", -5.445299556896683),
                                    ("<day-of-month> (ordinal or number) of <named-month>",
                                     -5.850764665004847),
                                    ("this|last|next <cycle>", -4.241326752570746),
                                    ("Mother's Day", -5.445299556896683),
                                    ("friday", -5.445299556896683),
                                    ("<time-of-day> am|pm (verbose)", -5.157617484444901),
                                    ("<time> after next", -5.850764665004847),
                                    ("day", -1.8995209464234195),
                                    ("next <day-of-week>", -4.9344739331306915),
                                    ("afternoon", -4.146016572766421),
                                    ("February", -4.9344739331306915),
                                    ("quarter", -4.7521523763367375),
                                    ("this <cycle>", -5.850764665004847),
                                    ("sunday", -5.850764665004847),
                                    ("time-of-day (latent)", -2.960392907108682),
                                    ("year", -3.548179572010801),
                                    ("<time-of-day> am|pm", -3.4528693922064764),
                                    ("<duration> after <time>", -5.157617484444901),
                                    ("hh:mm", -4.7521523763367375),
                                    ("intersect by ','", -5.157617484444901),
                                    ("intersect by 'of', 'from', 's", -3.9048545159495336),
                                    ("last <time>", -4.464470303884956),
                                    ("EOM|End of month", -5.850764665004847),
                                    ("March", -4.5980016965094785),
                                    ("<day-of-month> (ordinal)", -4.7521523763367375),
                                    ("noon", -5.445299556896683), ("hour", -1.9387416595767009),
                                    ("evening", -4.464470303884956), ("month", -2.9329939329205676),
                                    ("EOD|End of day", -5.850764665004847),
                                    ("next <time>", -4.7521523763367375),
                                    ("christmas", -5.445299556896683),
                                    ("next n <cycle>", -4.5980016965094785),
                                    ("tuesday", -5.157617484444901),
                                    ("halloween day", -5.850764665004847),
                                    ("winter", -5.850764665004847),
                                    ("last n <cycle>", -4.7521523763367375),
                                    ("last <cycle> of <time>", -4.5980016965094785),
                                    ("minute", -3.0474042840983118),
                                    ("week-end", -5.445299556896683),
                                    ("summer", -5.850764665004847), ("August", -5.850764665004847)],
                               n = 315},
                   koData =
                     ClassData{prior = -1.5488132906176655,
                               unseen = -5.5093883366279774,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -3.713572066704308),
                                    ("<duration> hence|ago", -4.812184355372417),
                                    ("<named-month> <day-of-month> (ordinal or number)",
                                     -4.812184355372417),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -3.202746442938317),
                                    ("September", -4.812184355372417),
                                    ("October", -4.406719247264253),
                                    ("<ordinal> quarter", -4.812184355372417),
                                    ("intersect", -3.202746442938317),
                                    ("the <cycle> of <time>", -3.8958936234982624),
                                    ("year (latent)", -4.812184355372417),
                                    ("April", -4.812184355372417),
                                    ("this|last|next <cycle>", -4.812184355372417),
                                    ("day", -2.173127025757159), ("afternoon", -4.812184355372417),
                                    ("quarter", -4.119037174812472),
                                    ("time-of-day (latent)", -2.46080909820894),
                                    ("year", -4.812184355372417), ("hh:mm", -4.812184355372417),
                                    ("nograin", -3.3081069585961433),
                                    ("until <time>", -3.3081069585961433),
                                    ("intersect by 'of', 'from', 's", -4.812184355372417),
                                    ("March", -4.406719247264253),
                                    ("<day-of-month> (ordinal)", -2.866274206317104),
                                    ("hour", -2.414289082574047), ("month", -2.7327428136925813),
                                    ("last <cycle>", -4.119037174812472),
                                    ("<datetime> - <datetime> (interval)", -4.812184355372417),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -4.406719247264253),
                                    ("minute", -3.713572066704308), ("August", -4.406719247264253)],
                               n = 85}}),
       ("dd/mm/yyyy",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.6094379124341003,
