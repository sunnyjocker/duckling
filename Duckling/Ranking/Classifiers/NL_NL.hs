       ...
       ("on <date>",
        Classifier{okData =
                     ClassData{prior = -0.10536051565782628,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("thursday", -3.258096538021482),
                                    ("<time> <part-of-day>", -3.0349529867072724),
                                    ("dd/mm", -3.0349529867072724),
                                    ("saturday", -3.951243718581427),
                                    ("intersect", -1.3485540331370436),
                                    ("<day-of-month>(ordinal) <named-month>", -3.951243718581427),
                                    ("friday", -3.951243718581427), ("day", -1.8718021769015913),
                                    ("hh:mm", -3.951243718581427),
                                    ("<day-of-month> (ordinal)", -3.545778610473263),
                                    ("hour", -1.8111775550851565),
                                    ("<datetime> - <datetime> (interval)", -3.951243718581427),
                                    ("<day-of-month> (non ordinal) <named-month>",
                                     -3.951243718581427),
                                    ("minute", -1.9363406980391626)],
                               n = 45},
                   koData =
